...
public class DatabaseControllerNullUnescapeAdapter implements DatabaseController {
    ...
    public String DatabaseTableGetFieldString(long tableVersion, long rowVersion, int column) throws RemoteException {
        return CorbaServer.UnescapeNull(controller.DatabaseTableGetFieldString(tableVersion, rowVersion, column));
    }
    ...
    public void DatabaseTableSetFieldStr(long tableVersion, long rowVersion, int column, String strValue) throws RemoteException {
        controller.DatabaseTableSetFieldStr(tableVersion, rowVersion, column, CorbaServer.EscapeNull(strValue));
    }
